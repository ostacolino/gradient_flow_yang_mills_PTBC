...
/* PARAMETERS FOR ALTIVEC */
		...
		#define ALTI_SL1_PERM (vector unsigned char)(1, 2, 3, 4, 5, 6, 7, 31, 9, 10, 11, 12, 13, 14, 15, 0)
		#define ALTI_SL1_MSK (vector unsigned long)(0xffffffffU, 0xffffe000U, 0xffffffffU, 0xffffe000U)
