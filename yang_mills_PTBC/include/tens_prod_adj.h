	...
	for(i0 = 0; i0 < NCOLOR * NCOLOR - 1; i0++)
		...
		for(i1 = 0; i1 < NCOLOR * NCOLOR - 1; i1++)
			...
			for(i2 = 0; i2 < NCOLOR * NCOLOR - 1; i2++)
				{
				for(i3 = 0; i3 < NCOLOR * NCOLOR - 1; i3++) { A->comp[i0][i1][i2][i3] = 0.0; }
				}
			}
		}
	}
...
inline void one_TensProdAdj(TensProdAdj *restrict A)
	...
	for(i0 = 0; i0 < NCOLOR * NCOLOR - 1; i0++)
		{
		for(i1 = 0; i1 < NCOLOR * NCOLOR - 1; i1++) { A->comp[i0][i0][i1][i1] = 1.0; }
		}
	}
...
inline void equal_TensProdAdj(TensProdAdj *restrict A, TensProdAdj const *const restrict B)
	...
	for(i0 = 0; i0 < NCOLOR * NCOLOR - 1; i0++)
		...
		for(i1 = 0; i1 < NCOLOR * NCOLOR - 1; i1++)
			...
			for(i2 = 0; i2 < NCOLOR * NCOLOR - 1; i2++)
				{
				for(i3 = 0; i3 < NCOLOR * NCOLOR - 1; i3++) { A->comp[i0][i1][i2][i3] = B->comp[i0][i1][i2][i3]; }
				}
			}
		}
	}
...
inline void times_equal_real_TensProdAdj(TensProdAdj *restrict A, double r)
	...
	for(i0 = 0; i0 < NCOLOR * NCOLOR - 1; i0++)
		...
		for(i1 = 0; i1 < NCOLOR * NCOLOR - 1; i1++)
			...
			for(i2 = 0; i2 < NCOLOR * NCOLOR - 1; i2++)
				{
				for(i3 = 0; i3 < NCOLOR * NCOLOR - 1; i3++) { A->comp[i0][i1][i2][i3] *= r; }
				}
			}
		}
	}
...
// A=B*C
inline void times_TensProdAdj(TensProdAdj *restrict A, TensProdAdj const *const restrict B, TensProdAdj const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
			...
			for(k = 0; k < NCOLOR * NCOLOR - 1; k++)
				...
				for(l = 0; l < NCOLOR * NCOLOR - 1; l++)
					...
					for(a = 0; a < NCOLOR * NCOLOR - 1; a++)
						{
						for(b = 0; b < NCOLOR * NCOLOR - 1; b++) { sum += B->comp[i][a][k][b] * C->comp[a][j][b][l]; }
						}
					A->comp[i][j][k][l] = sum;
					}
				}
...
inline double retr_TensProdAdj(TensProdAdj const *const restrict A)
	...
	for(i0 = 0; i0 < NCOLOR * NCOLOR - 1; i0++)
		{
		for(i1 = 0; i1 < NCOLOR * NCOLOR - 1; i1++) { tr += A->comp[i0][i0][i1][i1]; }
		}
