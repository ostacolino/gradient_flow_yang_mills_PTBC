...
// A=b*B+c*C
inline void lin_comb_U1(U1 *restrict A, double b, U1 const *const restrict B, double c, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=b*B^{dag}+c*C
inline void lin_comb_dag1_U1(U1 *restrict A, double b, U1 const *const restrict B, double c, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=b*B+c*C^{dag}
inline void lin_comb_dag2_U1(U1 *restrict A, double b, U1 const *const restrict B, double c, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=b*B^{dag}+c*C^{dag}
inline void lin_comb_dag12_U1(U1 *restrict A, double b, U1 const *const restrict B, double c, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=B*C
inline void times_U1(U1 *restrict A, U1 const *const restrict B, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=B^{dag}*C
inline void times_dag1_U1(U1 *restrict A, U1 const *const restrict B, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=B*C^{dag}
inline void times_dag2_U1(U1 *restrict A, U1 const *const restrict B, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
...
// A=B^{dag}*C^{dag}
inline void times_dag12_U1(U1 *restrict A, U1 const *const restrict B, U1 const *const restrict C)
	{
	#ifdef DEBUG
	if(A == B || A == C || B == C)
		{
